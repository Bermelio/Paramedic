        ...
        {isExpanded && (
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            ...
            <div className="flex justify-end">
              <button
                onClick={handleSave}
                className="bg-amber-600 hover:bg-amber-700 text-white font-medium py-2 px-6 rounded-md transition-colors duration-200 max-w-xs w-full mx-auto justify-center flex items-center gap-2"
                >
                Guardar Campeonato
              </button>
            </div>
